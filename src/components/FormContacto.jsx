...
const FormContacto = () => {
    ...
    return (
        <div className="backGroundContacto">
                        ...
                        <div className="block rounded-lg shadow-lg py-10 md:py-12 px-4 md:px-6"
                            ...
                            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-x-6 mb-12">
                                ...
                                <div className="mb-12 lg:mb-0 text-center mx-auto">
                                    ...
                                    <h6 className="font-medium">Barranquilla, 080001</h6>
                                </div>
                                <div className="mb-6 md:mb-0 text-center mx-auto">
                                    ...
                                    <h6 className="font-medium">+ 57 3012700081</h6>
                                </div>
                                <div className="text-center mx-auto">
                                    ...
                                    <h6 className="font-medium">Tax ID: 200 15 27 32</h6>
                                </div>
                            </div>
            ...
            " id="exampleFormControlTextarea13" rows="3" placeholder="Ingrese la solicitud"></textarea>
                                    </div>
